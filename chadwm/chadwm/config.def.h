...
static const char *fonts[]          = {"Monaspace Argon:style:medium:size=12" ,"JetBrainsMono Nerd Font Mono:style:medium:size=19" };
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_e,       spawn,          SHCMD("rofi -show drun") },
